 ...
 *
 * Field arithmetic in GF(2^255-19) using 551-bit limbs.
...
{
    uint128_t r;
    /* Use compiler builtin for 6464→128 if available */
...
static void fe_frombytes(fe25519 *h, const uint8_t s[32])
{
    ...
    /* Re-implement with proper bit slicing into 551 limbs */
...
static void fe_tobytes(uint8_t s[32], const fe25519 *h)
{
    ...
    /* Clear output buffer before byte-wise unpack */
    kmemset(s, 0, 32);
