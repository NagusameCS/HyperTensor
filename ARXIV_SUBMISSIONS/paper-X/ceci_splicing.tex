...
\begin{figure}[htbp]\centering\includegraphics[width=0.92\linewidth]{paper_x_ceci.png}\caption{Paper X: CECI model grafting — 7 Danish chimeras measured. 5 of 7 improve MMLU over parent models.}\label{fig:paper-x}\end{figure}
