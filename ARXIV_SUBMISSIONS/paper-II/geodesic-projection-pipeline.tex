...
architectures. $k_\text{int}$ is the TwoNN estimator of
\citet{facco2017twonn}; $k_{95}$ is the PCA-95\% component count from
the same \texttt{legacy/axiom\_vis/<model>/phase\{1,4\}\_*.json} files.}
