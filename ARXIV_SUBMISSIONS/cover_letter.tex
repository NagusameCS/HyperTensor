...
cross-model generalization of the GTC specifically has not been measured.
Cross-model validation of the underlying GRC attention compression is now
complete (Paper~VI, SmolLM2 + Qwen2.5), confirming architecture-independent
