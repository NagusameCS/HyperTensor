...
\phantomsection\addcontentsline{toc}{section}{Paper XVIII: Riemann Proof Search}
\includepdf[pages=-,pagecommand={\thispagestyle{empty}}]{paper-XVIII/proof_search.pdf}
...
\phantomsection\addcontentsline{toc}{section}{Paper XXXI: The Hodge Manifold}
\includepdf[pages=-,pagecommand={\thispagestyle{empty}}]{paper-XXXI/hodge.pdf}
