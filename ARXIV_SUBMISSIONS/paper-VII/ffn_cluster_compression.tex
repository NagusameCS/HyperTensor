...
\begin{figure}[htbp]\centering\includegraphics[width=0.92\linewidth]{paper_vii_ffn.png}\caption{Paper VII: FFN cluster compression — 4-cluster SVD achieves 23\% error reduction vs global SVD. Weight-norm proxy FALSIFIED at extreme compression.}\label{fig:paper-vii}\end{figure}
