...
\begin{htnote}
Project nomenclature.  HyperTensor is the project umbrella;
Geodesic Projection (GP) is the inference-time pipeline (companion
paper); Geodesic Runtime Compression (GRC) is its attention-only
subset; and OTT/GTC (Organic Tensor Topology / Geodessical Tensor
...
Under Organic Training Theory (OTT), the trained latent space is treated as
...
\textbf{TwoNN $k_\text{int}{=}5.36$} and 156 PCA components for
...
script:\\
\texttt{scripts/hjb\_feasibility.py}.
