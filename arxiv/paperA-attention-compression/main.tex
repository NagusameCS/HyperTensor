...
2048$^\dagger$ & 101.04 & 108.48 & 99.34 & 7.69 (+13.30\%) \\
\midrule
baseline & 100.00 & 100.00 & 100.00 & 6.79 \\
\bottomrule
\end{tabular}
\medskip\\
{\footnotesize $\dagger$ \texttt{AXEX\_MANIFOLD\_K\_MAX=1536} silently
clamps $k{=}2048$ to $k{=}1536$; identical PPL is consistent.}
\end{table}
...
on a few hundred directions.  Compressing FFN globally would lose
unacceptable information; compressing attention globally is benign at
$k\!\geq\!1536$ on this model.
...
$k{=}2048^\dagger$ decode retention     & $\geq 75\%$ & 101.04\% & PASS\\
$k{=}2048^\dagger$ prefill overhead     & $\leq 225\%$& 108.48\% & PASS\\
...
\item $k{=}2048$ (silently capped to 1536): full-rank proxy at parity.
\end{itemize}
