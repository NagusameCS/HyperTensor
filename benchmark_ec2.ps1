...
# GRC is now viable for Phi too — axpca_compute_topk uses Gram-matrix path (n×n) when
# n_samples < ff_dim, so even ff_dim=8192 calibration with n=32 samples runs a 32×32
